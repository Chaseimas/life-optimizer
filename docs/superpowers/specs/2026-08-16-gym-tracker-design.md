...
- **Tape measurements**: `measures` store, Scans tab gains a SCANS|TAPE toggle; neck/chest/arms/waist/thighs/calves/forearms (calves + forearms added 2026-08-21) with per-entry deltas; Compare stats table gains tape rows; Trends gains a waist chart (validated rose `#d4688a`).
